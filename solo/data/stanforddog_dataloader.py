...
def prepare_datasets_linear(
    ...
    assert dataset in ["cifar10", "cifar100", "stl10", "imagenet", "imagenet100", "pathmnist", "stanford_cars", "cub200", "oxford102flowers", "fgvc_aircraft", "nabirds", "stanford_dogs","custom"]
